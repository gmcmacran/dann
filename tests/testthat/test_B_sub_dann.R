...
test_that("Too many columns in yTrain error.", {
  expect_error(sub_dann(xTrain, TooManyyTrain), NULL)
})
rm(TooManyyTrain)
...
test_that("k checks works", {
  expect_error(sub_dann(xTrain, yTrain, c(3, 2), 3, 1, FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, "3", 3, 1, FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 100000, 3, 1, FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 0, 3, 1, FALSE, FALSE, "mcd", 2), NULL)
})

test_that("neighborhood_size checks works", {
  expect_error(sub_dann(xTrain, yTrain, 2, c(2, 3), 1, FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, "3", 1, FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 100000, 1, FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 0, 1, FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 4, 3, 1, FALSE, FALSE, "mcd", 2), NULL)
})

test_that("epsilon checks works", {
  expect_error(sub_dann(xTrain, yTrain, 2, 2, c(2, 3), FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, "1", FALSE, FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, -1, FALSE, FALSE, "mcd", 2), NULL)
})

test_that("probability checks works", {
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, c(TRUE, FALSE), FALSE, "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, "TRUE", FALSE, "mcd", 2), NULL)
})

test_that("weighted checks works", {
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, c(TRUE, FALSE), "mcd", 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, "TRUE", "mcd", 2), NULL)
})

test_that("sphere checks works", {
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, FALSE, c("mcd", "mcd"), 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, FALSE, FALSE, 2), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, FALSE, "foo", 2), NULL)
})

test_that("numDim checks works", {
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, FALSE, "mcd", c(1, 2)), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, FALSE, "mcd", "2"), NULL)
  expect_error(sub_dann(xTrain, yTrain, 2, 2, 1, FALSE, FALSE, "mcd", 0), NULL)
})
