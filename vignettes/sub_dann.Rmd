...
As an upper bound on performance for this A.I. approach, lets use only the informative variables. There is some improvement to be had.
...
Overall, dann with the correct variables did better than sub_dann. But in practice, it is usually unknown which variables are informative. The best course of action is to find the best set of variables. But due to project timelines, this is not always an option. subb_dann is an option to gain some level of performance with minimal work.
